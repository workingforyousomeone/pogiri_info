...
📐 *భవనం:* ${findRow[headers.indexOf("Building Sq Feet")]} చ.అడుగులు | ${findRow[headers.indexOf("Floors")]} అంతస్తులు
🔳 *స్థలం:* ${findRow[headers.indexOf("Site Sq Yards")]} చ.గజాలు
🌅 తూర్పు: ${findRow[headers.indexOf("East")]}
🌇 పడమర: ${findRow[headers.indexOf("West")]}
🏔️ ఉత్తరం: ${findRow[headers.indexOf("North")]}
🏖️ దక్షిణం: ${findRow[headers.indexOf("South")]}
------------------------------------------
